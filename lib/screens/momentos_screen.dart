...
import '../theme/absolute_theme.dart'; // Ajusta esto si tu archivo de tema se llama distinto
...
class MomentosScreen extends StatelessWidget {
  ...
  final List<Momento> misMomentos = [
    Momento(
      ...
      imagenRuta: 'assets/images/BaneBatman.png', // Cambia por tu imagen
      ...
      videoRuta: 'assets/videos/banevsbatman.mp4', // Cambia por el nombre de tu video real
    ),
    Momento(
      titulo: 'Aparicion de Absolute Joker',
      imagenRuta: 'assets/images/AbsoluteJoker.png', // Cambia por tu imagen
      ...
      videoRuta: 'assets/videos/AbsoluteJoker.mp4', // Cambia por el nombre de tu video real
    ),
    Momento(
      titulo: 'Aparicion de Absolute Ivy',
      imagenRuta: 'assets/images/AbsoluteIvy.png', // Cambia por tu imagen
      ...
      videoRuta: 'assets/videos/AbsoluteIvy.mp4', // Cambia por el nombre de tu video real
    ),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: kAbsoluteBlack, // Usando tu color de fondo
      appBar: AppBar(
        title: const Text('Momentos Épicos'),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              // Navegamos a la pantalla de detalle enviando el momento seleccionado
              Navigator.push(
                context,
                MaterialPageRoute(
            ...
            child: Card(
              color: Colors.grey[900], // Un gris muy oscuro para destacar sobre el negro
              margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
              clipBehavior: Clip.antiAlias, // Redondea las esquinas de la imagen
              child: Column(
                children: [
                  Image.asset(
                    momento.imagenRuta, 
